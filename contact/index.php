...
?>
    ...
    <section id="main-content" class="clear">
        ...
        <article>
            ...
            <h1>Enquire Now</h1>
            <p>You can write to us regarding any queries you may have regarding the services. You are also welcome to
                provide us with your valuable Feedback. We will respond to you within 24 hours' time.</p>
            <form id="contact-page" method="post" action=""
                  onSubmit="return alert('Thankyou for your Enquiry.\n We will get back to you within 24-48hrs.')">
                <fieldset>
